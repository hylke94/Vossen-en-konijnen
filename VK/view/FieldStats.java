...
public class FieldStats
{
	...
	public FieldStats()
    {
        ...
        // we might find
        this.counters = new HashMap<Class, Counter>();
    ...
    public String getPopulationDetails(Field field)
    {
        ...
        for(Class<?> key : this.counters.keySet()) {
            Counter info = this.counters.get(key);
    ...
    public void reset()
    {
        ...
        for(Class<?> key : this.counters.keySet()) {
            Counter count = this.counters.get(key);
            count.reset();
        }
    }
    ...
    {
        Counter count = this.counters.get(animalClass);
        if(count == null) {
